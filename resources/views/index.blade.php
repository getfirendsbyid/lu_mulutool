    ...
    <div id="wrap">
        ...
        <div class="view" id="tp734">
            ...
            <div class="view_right">
                ...
                <p align="left">&nbsp;<a title="{{\script\biaoqian::正常标题()}}" href="{{\script\biaoqian::random_url()}}">{{\script\biaoqian::重复标题()}}</a>&nbsp;<font
                            color="#999999">人气:[3407]</font></p>

                <p align="left">&nbsp;<a title="{{\script\biaoqian::正常标题()}}"
                                         href="{{\script\biaoqian::random_url()}}">{{\script\biaoqian::重复标题()}}</a>&nbsp;<font
                            color="#999999">人气:[3643]</font></p>

                <p align="left">&nbsp;<a title="{{\script\biaoqian::正常标题()}}" href="{{\script\biaoqian::random_url()}}">{{\script\biaoqian::重复标题()}}</a>&nbsp;<font
                            color="#999999">人气:[2193]</font></p>

                <p align="left">&nbsp;<a title="{{\script\biaoqian::正常标题()}}" href="{{\script\biaoqian::random_url()}}">{{\script\biaoqian::重复标题()}}
                ...
                <div class="view_pnews">
                    ...
                    <br/>
                    <a href='{{\script\biaoqian::random_url()}}' title='{{\script\biaoqian::正常标题()}}'>{{\script\biaoqian::重复标题()}}</a>
                </div>
                ...
                <p align="left">&nbsp;<a href="{{\script\biaoqian::random_url()}}" title="{{\script\biaoqian::正常标题()}}"
                                         target="_blank">{{\script\biaoqian::重复标题()}}</a></p>
                ...
                <p align="left">&nbsp;<a href="{{\script\biaoqian::random_url()}}"
                                         title="{{\script\biaoqian::正常标题()}}" target="_blank">{{\script\biaoqian::重复标题()}}</a></p>
                ...
                <p align="left">&nbsp;<a href="{{\script\biaoqian::random_url()}}"
                                         title="{{\script\biaoqian::正常标题()}}" target="_blank">{{\script\biaoqian::重复标题()}}</a>
                </p>
